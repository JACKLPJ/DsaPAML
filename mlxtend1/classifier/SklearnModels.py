...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        return None
    try:
        auc=roc_auc_score(y_test, y_pro, average='weighted', multi_class='ovr')
    except:
        try:
            auc=roc_auc_score(y_test, y_pro[:,1])
        except:
            auc=0
    #print('svm finished!')
    return 'lda', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'qda', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'svm', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'knn', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'gnb', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'mnb', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'bnb', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'dt', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'rf', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'gb', [clf, preprocessing_dic], acc, y_hat, auc      
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'etree', [clf, preprocessing_dic], acc, y_hat, auc
...
#     from sklearn.metrics import accuracy_score
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'lgb', [clf, preprocessing_dic], acc, y_hat, auc
...
#
    ...
    try:
        ...
        try:
            ...
            auc=0
    #print('svm finished!')
    return 'xgb', [clf, preprocessing_dic], acc, y_hat, auc
